    ...
    <div class="form--steps-container">
        ...
        <form:form method="post" modelAttribute="donation">
            ...
            <div data-step="1" class="active">
                ...
                <label>
                    <span class="error-text"><form:errors path="categories"/></span>
                </label>
            ...
            <div data-step="2">
                ...
                <div class="form-group form-group--inline">
                    <label>
                        Liczba 60l worków:
                        <form:input path="quantity" type="number" min="0" step="1" id="bags"/>
                    </label><br>
                    <label>
                        <span class="error-text"><form:errors path="quantity"/></span>
                    </label>
                </div>
                <div class="form-group form-group--buttons">
            ...
            <div data-step="3">
                ...
                <div class="form-group form-group--checkbox">
                    ...
                    <label>
                        <span class="error-text"><form:errors path="institution"/></span>
                    </label>
                </div>
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            ...
                            <label><span class="error-text"><form:errors path="street"/></span> </label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label> Miasto: <form:input path="city" id="city"/> </label>
                            <label><span class="error-text"><form:errors path="city"/></span></label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label>Kod pocztowy: <form:input path="zipCode" id="zipCode"/></label>
                            <label><span class="error-text"><form:errors path="zipCode"/></span></label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label>Telefon: <form:input path="phone" id="phone"/></label>
                            <label><span class="error-text"><form:errors path="phone"/></span></label>
                        </div>
                    ...
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            ...
                            <label>
                                <span class="error-text"><form:errors path="pickUpDate"/></span>
                            </label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label> Godzina <form:input type="time" path="pickUpTime" id="pickUpTime"/> </label>
                            <label><span class="error-text"><form:errors path="pickUpTime"/></span></label>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <ul>
                            <li>
                                ...
                                <span class="summary--text" id="categoriesAndBags"></span>
                            </li>

                            <li>
                                <span class="icon icon-hand"></span>
                                <span class="summary--text" id="organisation"></span>
                            </li>
                        </ul>
                    </div>
