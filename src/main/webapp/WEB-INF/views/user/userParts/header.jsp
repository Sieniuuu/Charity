...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href='<c:url value="/user/"/>'>
        ...
        <li class="nav-item active">
            <a class="nav-link" href='<c:url value="/user/editDetails"/>'>
                <i class="fas fa-fw fa-tachometer-alt"></i>
                <span class="font-size:3em">EDYTUJ PROFIL </span></a>
